...
-- Dumping data for table auth.permissions: ~6 rows (approximately)
...
-- Dumping data for table auth.roles_permissions: ~9 rows (approximately)
...
-- Dumping data for table auth.users: ~0 rows (approximately)
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
/*!40000 ALTER TABLE `users` ENABLE KEYS */;

-- Dumping structure for table auth.users_permissions
...
-- Dumping data for table auth.users_permissions: ~0 rows (approximately)
...
-- Dumping data for table auth.users_roles: ~0 rows (approximately)
